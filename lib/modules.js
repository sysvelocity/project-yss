...
const MODULES = {
  ...
  "6.4.1": {
    ...
    vectorStoreEnvVars: [],
    scopeClassifierPrompt: buildScopeClassifierPrompt(
      "build, refine, continue, or restart the conversational sales story example from the user's bridge line, customer issues addressed, offers, differentiators, attachments, and directly related source material"
    ),
    scopeErrorMessage:
